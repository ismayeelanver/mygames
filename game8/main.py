...
pygame.mixer.Channel(0).play(pygame.mixer.Sound(PATH + "/calling.mp3"), loops=-1)
w = 400
h = 800

screen = pygame.display.set_mode((w, h))
BG = pygame.image.load(PATH + "/Graphics/BG.png")
BG1 = pygame.image.load(PATH + "/Graphics/BG1.png")
Accept1 = pygame.image.load(PATH + "/Graphics/button.png")
Accept2 = pygame.image.load(PATH + "/Graphics/button.png")
a1_rect = Accept1.get_rect(center=(80, 600))
a2_rect = Accept2.get_rect(center=(290, 600))
Decline = pygame.image.load(PATH + "/Graphics/button2.png")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if a1_rect.collidepoint(pygame.mouse.get_pos()):
                ...
                BG = pygame.image.load(PATH + "/Graphics/BG1.png")
                Accept1.fill((0, 0, 0, 0))
                Accept2.fill((0, 0, 0, 0))
                Decline = pygame.image.load(PATH + "/Graphics/button1.png")
